    ...
    if(user){
      ...
      uploadBytes(storageRef, image)
        ...
        .then((url) => {
          ...
          addDoc(collection(firestore, 'products'), { // Add user data to 'users' collection
            id: uuidv4(),
                      ...
                      {/* <form className="bg-white p-6 w-full max-w-sm"> */}
                        ...
                        <div className="mb-4 w-full">
                          ...
                          />
                            ...
                            {image ? <img className="w-full mt-2" src={image ? URL.createObjectURL(image) : ''} width="150px" height="150px" alt="Post" /> : ''}
                        <button
                          type="submit"
